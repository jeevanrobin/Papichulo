...
final List<FoodItem> papichuloMenu = [
  ...
  FoodItem(name: 'Veggie Surprise', category: 'Pizza', type: 'Veg', ingredients: ['Broccoli', 'Peppers', 'Cheese'], imageUrl: 'https://images.unsplash.com/photo-1595854341625-f33ee10dbf94', price: 329, rating: 4.6),
  ...
  // Pizza - Non-Veg
  FoodItem(name: 'Chicken Paprika Pizza', category: 'Pizza', type: 'Non-Veg', ingredients: ['Chicken', 'Cheese', 'Paprika'], imageUrl: 'https://images.unsplash.com/photo-1534308983496-4fabb1a015ee', price: 349, rating: 4.6),
  FoodItem(name: 'Cheesy Orange Chicken Pizza', category: 'Pizza', type: 'Non-Veg', ingredients: ['Chicken', 'Double Cheese', 'Orange Sauce'], imageUrl: 'https://images.unsplash.com/photo-1513104890138-7c749659a591', price: 379, rating: 4.4),
  ...
  FoodItem(name: 'Chicken Cheese Blast', category: 'Pizza', type: 'Non-Veg', ingredients: ['Chicken', 'Triple Cheese', 'Spices'], imageUrl: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38', price: 399, rating: 4.7),
  ...
  FoodItem(name: 'Coleslaw Veg Burger', category: 'Burgers', type: 'Veg', ingredients: ['Veg Patty', 'Coleslaw', 'Cheese'], imageUrl: 'https://images.unsplash.com/photo-1520072959219-c595dc870360', price: 229, rating: 4.2),
  ...
  // Burgers - Non-Veg
  FoodItem(name: 'Chicken Burger', category: 'Burgers', type: 'Non-Veg', ingredients: ['Chicken Patty', 'Cheese', 'Sauce'], imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd', price: 249, rating: 4.5),
  ...
  FoodItem(name: 'Coleslaw Veg Sandwich', category: 'Sandwiches', type: 'Veg', ingredients: ['Coleslaw', 'Veg', 'Cheese'], imageUrl: 'https://images.unsplash.com/photo-1541519227354-08fa5d50c44d', price: 169, rating: 4.1),
  ...
  FoodItem(name: 'Chicken Tikka Sandwich', category: 'Sandwiches', type: 'Non-Veg', ingredients: ['Chicken Tikka', 'Bread', 'Sauce'], imageUrl: 'https://images.unsplash.com/photo-1621852004158-f3bc188ace2d', price: 199, rating: 4.4),
  FoodItem(name: 'Coleslaw Chicken Sandwich', category: 'Sandwiches', type: 'Non-Veg', ingredients: ['Chicken', 'Coleslaw', 'Bread'], imageUrl: 'https://images.unsplash.com/photo-1588195538326-c5b1e9f80a1b', price: 179, rating: 4.3),
  ...
  // Hot Dogs
  FoodItem(name: 'Chilli Cheese Dog', category: 'Hot Dogs', type: 'Non-Veg', ingredients: ['Hot Dog', 'Chilli', 'Cheese'], imageUrl: 'https://images.unsplash.com/photo-1599599810769-bcde5a160d32', price: 129, rating: 4.2),
  ...
  FoodItem(name: 'BBQ Dog', category: 'Hot Dogs', type: 'Non-Veg', ingredients: ['Hot Dog', 'BBQ Sauce', 'Cheese'], imageUrl: 'https://images.unsplash.com/photo-1599599810769-bcde5a160d32', price: 139, rating: 4.3),
  FoodItem(name: 'Papichulo Special Dog', category: 'Hot Dogs', type: 'Non-Veg', ingredients: ['Hot Dog', 'Special Sauce', 'Toppings'], imageUrl: 'https://images.unsplash.com/photo-1599599810769-bcde5a160d32', price: 159, rating: 4.6),
